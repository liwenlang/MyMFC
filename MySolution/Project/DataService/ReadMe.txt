========================================================================
    MICROSOFT 基础类库 : DataService 项目概述
========================================================================


应用程序向导已为您创建了此 DataService DLL。  此 DLL 不仅演示 
Microsoft 基础类的基本使用方法，还可作为您编写 DLL 的起点。

本文件概要介绍组成 DataService DLL 的每个文件的内容。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 DataService.pch 的预编译头 (PCH) 文件和名为 
    StdAfx.obj 的预编译类型文件。
