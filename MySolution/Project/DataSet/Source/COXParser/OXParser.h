...
class PMBASECLASSOPRAPI COXToken
{
public:
    enum TagTypes
    {      
...
class PMBASECLASSOPRAPI COXParserObject
{
public:
...
class PMBASECLASSOPRAPI COXAttribute : public COXParserObject
{
public:
...
class PMBASECLASSOPRAPI COXParserElement : public COXParserObject
{
public:
    COXParserElement();
	...
	int				NumElement() const;
    COXParserObject*  Object(int nIndex) const { return m_Objects[nIndex];   }

	COXParserElement * Object_Ele(int nIndex) const ;
	...
	//获取节点中的 显示文字 <xml>ReadText</xml>
	LPCTSTR GetElementValue() const;
	...
	LPCTSTR GetAttributeValue(LPCTSTR szName, bool bCaseSensitive = false);
...
class PMBASECLASSOPRAPI COXParser
{
public:
    enum ErrorTypes
    {
